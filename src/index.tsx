...
const ACTING_GALLERY = [
  ...
  { id: 'onset-4', kind: 'On Screen', label: 'THE SILENT CONTENDER', ratio: '4/3', img: '/static/images/acting/onset-3.jpg' },
  { id: 'onset-3', kind: 'On Set', label: 'THE SILENT CONTENDER', ratio: '3/4', img: '/static/images/acting/editorial-1.jpg' },
  { id: 'onset-5', kind: 'On Set', label: 'THE SILENT CONTENDER', ratio: '4/3', img: '/static/images/acting/onset-4.jpg' },
  { id: 'editorial-1', kind: 'Press', label: 'Pasadena International Film Festival', ratio: '3/4', img: '/static/images/acting/modeling-1.jpg' },
  ...
  { id: 'onset-6', kind: 'On Set', label: 'WIND IN THE WILLOW TREE', ratio: '4/3', img: '/static/images/acting/onset-5.jpg' },
  { id: 'headshot-5', kind: 'Headshot', label: 'Photo: Inda Reid', ratio: '3/4', img: '/static/images/acting/headshot-4.jpg' },
  { id: 'headshot-6', kind: 'Headshot', label: 'Photo: Inda Reid', ratio: '3/4', img: '/static/images/acting/headshot-5.jpg' },
  { id: 'modeling-4', kind: 'Modeling', label: '', ratio: '3/4', img: '/static/images/acting/modeling-4.jpg' },
]

const REEL_OPTIONS = [
  { id: 'acting-reel', label: 'Acting Reel', duration: '02:11', img: 'https://i.ytimg.com/vi/hbR0r_iUfWc/maxresdefault.jpg', youtubeId: 'hbR0r_iUfWc' },
...
const SERIES = [
  ...
  },
  {
    ...
    images: [
      ...
      '/static/images/photo/s02-5.jpg',
      '/static/images/photo/s02-6.jpg',
      '/static/images/photo/s02-7.jpg',
      '/static/images/photo/s02-8.jpg',
      '/static/images/photo/s02-9.jpg',
    ],
  },
  {
    num: 'S03',
