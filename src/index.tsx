...
const ACTING_GALLERY = [
  ...
  { id: 'editorial-1', kind: 'On Set', label: 'THE SILENT CONTENDER', ratio: '3/4', img: '/static/images/acting/editorial-1.jpg' },
  { id: 'modeling-1', kind: 'Press', label: 'Pasadena International Film Festival', ratio: '3/4', img: '/static/images/acting/modeling-1.jpg' },
  { id: 'onset-3', kind: 'On Screen', label: 'THE SILENT CONTENDER', ratio: '4/3', img: '/static/images/acting/onset-3.jpg' },
  { id: 'modeling-2', kind: 'Modeling', label: '', ratio: '3/4', img: '/static/images/acting/modeling-2.jpg' },
  { id: 'editorial-2', kind: 'Headshot', label: "Photo: Inda Reid", ratio: '3/4', img: '/static/images/acting/editorial-2.jpg' },
  { id: 'onset-4', kind: 'On Set', label: 'THE SILENT CONTENDER', ratio: '4/3', img: '/static/images/acting/onset-4.jpg' },
  { id: 'headshot-3', kind: 'Modeling', label: '', ratio: '3/4', img: '/static/images/acting/headshot-3.jpg' },
  { id: 'onset-5', kind: 'On Set', label: 'WIND IN THE WILLOW TREE', ratio: '4/3', img: '/static/images/acting/onset-5.jpg' },
  { id: 'editorial-3', kind: 'Modeling', label: '', ratio: '3/4', img: '/static/images/acting/editorial-3.jpg' },
  { id: 'modeling-3', kind: 'Headshot', label: 'Photo: Inda Reid', ratio: '3/4', img: '/static/images/acting/modeling-3.jpg' },
  { id: 'headshot-4', kind: 'Headshot', label: 'Photo: Inda Reid', ratio: '3/4', img: '/static/images/acting/headshot-4.jpg' },
  { id: 'headshot-5', kind: 'Headshot', label: 'Close Coverage', ratio: '3/4', img: '/static/images/acting/headshot-5.jpg' },
  { id: 'modeling-4', kind: 'Modeling', label: '', ratio: '3/4', img: '/static/images/acting/modeling-4.jpg' },
]
